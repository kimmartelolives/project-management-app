...
import { TASK_PRIORITY_CLASS_MAP, TASK_PRIORITY_TEXT_MAP, TASK_STATUS_TEXT_MAP, TASK_STATUS_CLASS_MAP } from "@/contants";
                  ...
                  <div className="grid gap-1 grid-cols-2 mt-2">
                    ...
                    <div>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="mt-1">
                            <Link href={route("project.show", task.project.id)} className="hover:underline">{task.project.name}</Link>
                          </p>
                        </div>
