                ...
                <div className="overflow-auto">
                  ...
                  <tbody>
                    {projects.data.map(project => (
                      ...
                      <tr className="bg-white broder-b dark:bg-gray-800 dark:border-gray-700"
                      key={project.id}
                      >
                      ...
                      <td className="px-3 py-2">
                        ...
                        <Link href={route('project.destroy', project.id)} className="font-medium text-red-600 dark:text-red-500
